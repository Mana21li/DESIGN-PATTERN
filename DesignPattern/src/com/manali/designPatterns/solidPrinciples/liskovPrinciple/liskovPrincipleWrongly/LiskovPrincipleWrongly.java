package com.manali.designPatterns.solidPrinciples.liskovPrinciple.liskovPrincipleWrongly;

import java.util.ArrayList;
import java.util.List;

public class LiskovPrincipleWrongly {
    ...
    public void processTrasaction() {
        for (Account account : accounts) {
            ...
            if(account instanceof FixedAccount){
                System.out.println("Skipping withdrawal for fixed account.");
            } else {
                try {
